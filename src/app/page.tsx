...
import logoAccede from '@/images/logos/accede-icon.png'
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Full Stack Engineer, and builder.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Clifford, a Full Stack Engineer with{' '}
            <b>{yearsOfExperience} years</b> of experience. I enjoy building
            both front-end and backend applications.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://x.com/NiiAnyetei1"
